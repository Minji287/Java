...
public class ClassTest {
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		Class pClass1 = person.getClass(); // getClass는 Object 것이므로 사용할 수 있다.
		// getClass가 하는 일은 Class Class를 반환해 주는 일을 한다.
		// getClass를 이용해서 Class Class를 가져오려고 한다.
		...
		// 밑줄 오류 시 add throws declaration을 해 주어라
		// forName("package_1.Person") package_1에 있는
		// Person 클래스를 가져와서 pClass3에 넣으라는 것
		
		System.out.println(pClass3.getName()); // package_1.Person 이 출력된다.
		// 위와 같이 class를 가져오는 방법 3가지를 소개 했다.
